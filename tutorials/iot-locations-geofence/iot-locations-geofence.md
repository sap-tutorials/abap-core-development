...
<!-- border -->![Heidelberg hospital AoI](MedicalAoI.png)
...
<!-- border -->![Geofence Configuration](GeofenceConfiguration.png)
...
<!-- border -->![Geofence Assignments](GeofenceAssignments.png)
...
1.    Retrieve the `ThingID`.
    ...
    <!-- border -->![GET ThingID](ThingID.png)
