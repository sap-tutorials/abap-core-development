...
# Set up and start the Jenkins Cx Server
...
### Copy cx-server folder from app to AWS
...
### Make cx-server script executable
...
### Try to run Cx Server in a browser
...
### Run the Cx Server in a browser
