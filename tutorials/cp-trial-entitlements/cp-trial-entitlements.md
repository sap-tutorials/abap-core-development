...
# Manage Entitlements on SAP Cloud Platform Trial
...
3. In the dropdown menu, select both subaccounts and choose **Go**.
    ...
    <!-- border -->![Entity Assignment Choosing All](EntityAssignment-ChooseAll.png)
...
Don't forget to increase the quota to the amount you need.
    ...
    <!-- border -->![Save Entitlements](SaveEntitlements.png)
