...
# Onboard Virtual Devices and Enable Them to Send Data
...
### Decide which devices to onboard
...
### Onboard some example devices using a script
...
### Start ingesting some data for the devices
