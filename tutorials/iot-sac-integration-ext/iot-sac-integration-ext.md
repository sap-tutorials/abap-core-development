...
2.	Click  <!-- border -->![Main](main_menu.png)  and select **Connection**.

    <!-- border -->![Connection](connection.png)

3.	In the **Connection** page, under **Connections** tab, click   <!-- border -->![Plus](plus.png) to add a new connection.
...
1. Click <!-- border -->![Main](main_menu.png) and select **Create > Story**.
