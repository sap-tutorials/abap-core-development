...
5. Copy to clipboard this example code for a request body of the SAP Translation Hub service
...
6. Exchange the default body with the code from before.

7. Hit the **Run** button.
   
8. The **RESPONSE** to the service call will appear.
...
6. Enter as **Host Name** `sandbox.api.sap.com`, which is the domain part of the before gotten service's end point. 
...
5. Press **Add** to start outbound service creation
    A pop up opens
