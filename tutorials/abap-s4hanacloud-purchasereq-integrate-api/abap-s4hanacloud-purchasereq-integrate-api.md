...
- For SAP S/4HANA on-premise, create developer user with full development authorization (`SAP_ALL`)
...
- How to enhance behavior definition of projection view
- How to enhance metadata extensions
- How to implement unmanaged save and `save_modified`
