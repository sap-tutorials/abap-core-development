...
# Get Configuration for the Edge Gateway Service
...
### Get Device Connectivity details
...
3.  Click in the column **Credentials** for the instance of SAP IoT on the field **X Keys** to open the service keys.
    ...
    <!-- border -->![servicekey](servicekey.png)
...
### Create the onboarding certificate
